...
class Horoscope:
    ...
    def get_todays_horoscope(sunsign):
        ...
        date = str(tree.xpath(
			"//*[@id=\"main-wrapper\"]/div[3]/div/div[1]/section/div[2]/div[1]/div/div[1]/h3/span/text()"))
        date = date.replace("['(", "").replace(")']", "")
        horoscope = str(tree.xpath(
			"//*[@id=\"main-wrapper\"]/div[3]/div/div[1]/section/div[2]/div[1]/div/div[1]/span/text()"))
    ...
    def get_weekly_horoscope(sunsign):
        ...
        tree = etree.parse(response, htmlparser)
        week = str(tree.xpath(
			"//*[@id=\"main-wrapper\"]/div[3]/div/div[1]/section/div[2]/div[1]/div/h3/span/text()"))
        week = week.replace("[u'\\n", "").replace("']", "").replace("\\u2013", "-")
        horoscope = str(tree.xpath(
			"//*[@id=\"main-wrapper\"]/div[3]/div/div[1]/section/div[2]/div[1]/div/span/text()"))
    ...
    def get_monthly_horoscope(sunsign):
        ...
        month = month.replace("['\\n", "").replace("']", "")
        horoscope = str(tree.xpath(
			"//*[@id=\"main-wrapper\"]/div[3]/div/div[1]/section/div[2]/div[1]/div/span/text()[1]"))
        horoscope = horoscope.replace("['", "").replace("']", "")
        dict = {
            'month': month,
            'horoscope': horoscope,
